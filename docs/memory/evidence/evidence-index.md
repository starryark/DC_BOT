...
| IEV-A8-003 | A8 | **No live soak has been executed.** No redacted report, operator attestation, observer record, or independent reviewer decision exists in this repository. A8 is open and no commit is designated active-ready. | `docs/memory/CURRENT.md` |
