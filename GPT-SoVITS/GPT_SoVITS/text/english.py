...
class en_G2p(G2p):
    ...
    def __call__(self, text):
        ...
        try:
            ...
            # NOTICE: NLTK installs its statistical tagger separately from the
            # Python package. POS is used only to choose among homographs below;
            # dictionary and predicted pronunciations remain available offline.
