 ...
 */
// Test file lives at airi/services/discord-bot/src/character/. The LIVE card
// is at <DC_BOT>/Makise Kurisu/card.json — five directories up from here.
const REPO_ROOT = resolvePath(__dirname, '../../../../..')
const CARD_DIR = resolvePath(REPO_ROOT, 'Makise Kurisu')
