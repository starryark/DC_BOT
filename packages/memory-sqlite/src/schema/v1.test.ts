...
describe('imp-201 schema v1', () => {
  it('creates every normalized schema object assigned to the persistence foundation', () => {
    expect(tableNames()).toEqual([
      ...
      'generation_layered_context_manifests',
      ...
      'memory_search_analyzers',
      'memory_search_cjk',
      'memory_search_cjk_config',
      'memory_search_cjk_content',
      'memory_search_cjk_data',
      'memory_search_cjk_docsize',
      'memory_search_cjk_idx',
      'memory_search_latin',
      'memory_search_latin_config',
      'memory_search_latin_content',
      'memory_search_latin_data',
      'memory_search_latin_docsize',
      'memory_search_latin_idx',
